...
function participants() {
  ...
  const Footer = () => {
    return (
        <div style={{flexGrow:1, display:"flex", justifyContent:"center", width:"100%", alignItem:"center"}}>
  ...
  const data = {
    columns: [
      { field: "sl", headerName: "ID", width: 50 },
      { field: "name", headerName: "Name", width: 200 },
      { field: "sex", headerName: "Gender", width: 150 },
      { field: "phone", headerName: "Phone", width: 200 },
      { field: "address", headerName: "Address", width: 200 },
      { field: "date", headerName: "Date of Birth", width: 150, type: "date",
  ...
  useEffect(() => {
    axios
      .get(`${process.env.NEXT_PUBLIC_API_URL}/auth/getAllUsers?page=${page}&pagination=${pagination}`)
      .then((res) => {
  ...
  return (
    <>
      ...
      <div className={styles.container}>
        <div className={styles.heading} style={{marginBottom:"7px"}}>Participants</div>
